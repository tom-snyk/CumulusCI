...
class CliTable:
    ...
    INNER_BORDER = True
    PICTOGRAM_TRUE = click.style("✔", fg="green")
    PICTOGRAM_FALSE = click.style("✘", fg="red")
    ...
    def ascii_table(self):
        ...
        table = AsciiTable(self.table.table_data, self._title)
        table.inner_row_border = self.INNER_BORDER
